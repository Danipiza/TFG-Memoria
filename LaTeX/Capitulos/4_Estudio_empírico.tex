...
\section{Algoritmos Evolutivos}
	...
	%\subsubsection{Mejora 2: Modelo de islas}
		...
		\begin{figure}[h!]
			...
			\end{tikzpicture}
			\caption{Tiempos de ejecución de la estrategia modelo de islas de los algoritmos evolutivos en ordenador de propósito general}
			\label{fig:pev_mpi2}
		\end{figure}
		...
		\begin{tikzpicture}
			...
			\end{axis}
		\end{tikzpicture}
		\caption{\textit{Speedups} de la estrategia modelos de islas de los algoritmos evolutivos en ordenador de propósito general}
	...
	%\subsubsection{Mejora 3: PipeLine}
		...
		\begin{itemize}
			...
			\item Con diez procesos: se duplica la ayuda para los \textit{workers} en la función de evaluación. Alcanzando, con este reparto de tareas, una igualdad en los tiempos de ejecución de los dos tipos de procesos \textit{worker}.
		\end{itemize}
		
		Como muestra la Figura \ref{pev:estrategia_mpi3_2}, los individuos reales también presentan un buen rendimiento. Aunque se dupliquen los procesos \textit{workers} ejecutados, no se consigue disminuir más la reducción alcanzada con cuatro procesos. 
		...
		\begin{figure}[!h]
			...
			\end{axis}
			\end{tikzpicture}
			\caption{Tiempo de ejecución de la estrategia pipeline en los individuos binarios del algoritmo evolutivo en ordenador de propósito general}
		...
		La estrategia de pipeline se ejecuta sobre individuos árboles, siguiendo el mismo reparto de tareas que la utilizada para los individuos reales. Como se comentó antes, al llegar a \textit{10} procesos se alcanza una igualdad en los tiempos de ejecución. Es por esos que los procesos ejecutados para esta prueba son múltiplos de este número, siendo \textit{10}, \textit{20}, \textit{40} y \textit{80}. Entre cada prueba se duplican los procesos involucrados en cada tarea, incluyendo la inicialización de los individuos realiza por el proceso \textit{master}. Los resultados obtenidos son mostrados en la Figura \ref{fig:pev_cluster2}. Se puede apreciar un comportamiento similar a la Figura \ref{pev:estrategia_mpi3_2} del párrafo anterior, en el cual al llegar a \textit{40} procesos se obtienen aproximadamente los mismos resultados que duplicando los procesos.
			...
			\begin{figure}[!h]
				...
				\begin{tikzpicture}
					...
					\end{axis}
				\end{tikzpicture}
				\caption{Tiempos de ejecución de la estrategia dividir la población en los individuos reales del algoritmo evolutivo en Cluster}
			...
			\begin{figure}[!h]
				...
				\end{axis}
				\end{tikzpicture}
				\caption{Tiempo de ejecución de la estrategia pipeline en los individuos árboles del algoritmo evolutivo en Cluster}
