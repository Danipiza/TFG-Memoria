	...
	\end{flushleft}		
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				\addplot [mark=none, color=blue, line width=1.2pt] table [x index=0, y index=1, col sep=space] {files/multiplicacion.txt};
				\addplot [mark=none, color=red, line width=1.2pt] table [x index=0, y index=2, col sep=space] {files/multiplicacion.txt};
